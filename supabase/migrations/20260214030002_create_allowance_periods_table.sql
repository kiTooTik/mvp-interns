-- Create Allowance Periods Table
-- This migration creates the allowance_periods table for advanced allowance management
...
-- Ensure columns exist when table pre-exists from earlier migration (base has only id, start_date, end_date, locked_at, locked_by, created_at)
...
CREATE INDEX IF NOT EXISTS idx_allowance_periods_created_by ON allowance_periods(created_by);

-- Add comments for documentation
COMMENT ON TABLE allowance_periods IS 'Allowance periods for advanced day-by-day processing and budget tracking';
