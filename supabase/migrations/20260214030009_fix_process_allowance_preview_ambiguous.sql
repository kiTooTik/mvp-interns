-- Fix: "column reference 'v_date' is ambiguous" in process_allowance_preview.
-- Replaces the function so the perDayBreakdown subquery uses alias 'd' instead of 'v_date'.
